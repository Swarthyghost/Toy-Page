      ...
      <article className="max-w-4xl mx-auto px-4 md:px-6">
            ...
            {recommendedProducts.length > 0 && (
              <div className="bg-zinc-900/30 border border-white/10 rounded-[2rem] p-6 md:p-8 mt-16 space-y-6">
                <div className="space-y-1">
                  ...
                  <h3 className="text-xl md:text-2xl font-display font-bold">Featured Products from this Guide</h3>
                </div>
        ...
        {relatedGuides.length > 0 && (
          <div className="pt-16 mt-20 border-t border-white/10 space-y-8">
            <h3 className="text-2xl font-display font-bold">Related Guides</h3>
              ...
              {relatedGuides.map((item) => (
                ...
                >
                  ...
                  <div className="p-4 flex flex-col flex-grow space-y-2">
                    ...
                    <h4 className="font-bold text-base font-display line-clamp-1 group-hover:text-primary transition-colors">
