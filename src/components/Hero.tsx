...
const MARQUEE_ITEMS = [
  'Premium Quality', 'Discreet Delivery', '100% Private', 'Fast Shipping',
  'Body Safe', 'Curated Collection', 'Ghana\'s Best', 'Discreet Packaging',
];
    ...
    <div className="relative overflow-hidden py-3 bg-primary/10 border-y border-primary/20">
      ...
      >
        {[...MARQUEE_ITEMS, ...MARQUEE_ITEMS].map((item, i) => (
          <span key={i} className="inline-flex items-center gap-3 text-xs font-bold uppercase tracking-[0.2em] text-primary/70">
        ...
        >
          <div className="grid lg:grid-cols-[1fr_420px] gap-16 items-center">
            ...
            <div>
              ...
              >
                A curated collection of premium toys, elegant restraints and sensual accessories — delivered with complete privacy across Ghana.
              </motion.p>
              ...
              <div className="relative bg-white/5 border border-white/10 rounded-[2.5rem] overflow-hidden">
                ...
                <div className="px-6 pb-6 flex flex-wrap gap-2">
                  {features.map(({ icon: Icon, text }) => (
                    <div key={text} className="flex items-center gap-1.5 px-3 py-1.5 bg-white/5 border border-white/10 rounded-full text-[11px] text-white/50">
