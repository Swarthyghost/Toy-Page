        ...
        <div className="bg-white/5 border border-white/10 rounded-[3rem] p-10">
          <form className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <textarea className="w-full px-6 py-4 bg-white/5 border border-white/10 rounded-2xl focus:border-primary focus:outline-none transition-colors min-h-[150px] resize-none" />
            </div>
